...
int hardtriggers_lockout_timer = 0;  //Sets a counter to the user-defined hardtriggers lockout period
...
{
  // hardtriggers_lockout_timer = hardtriggers_lockout_timer-1;
